...
<head>
    ...
    <title>Solicitud de aumento de plazo</title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 30px; color: #333333; font-size: 15px;">
                            <h2 style="text-align: center; font-size: 20px; margin-bottom: 25px;">Solicitud de aumento de plazo</h2>
                            ...
                            <p style="margin-bottom: 15px;">
                                <strong>Días solicitados:</strong> {{ $dias_extra }}
                            </p>

                            <p style="margin-bottom: 15px;">
                                <strong>Nueva fecha de devolución:</strong> {{ $fechaDevolucion }}
                            </p>
