...
<head>
    ...
    <title>Rechazo de solicitud de aumento plazo de préstamo</title>
</head>
                ...
                <table width="600" cellpadding="0" cellspacing="0" style="background-color: #ffffff; border-radius: 8px; overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 30px; color: #333333; font-size: 15px;">
                            <h2 style="text-align: center; font-size: 20px; margin-bottom: 25px;">Solicitud de aumento plazo de préstamo rechazada</h2>

                            <p style="margin-bottom: 15px;">
                                Lamentamos informarte que tu solicitud para extender el plazo del préstamo del siguiente libro ha sido <strong>rechazada</strong>.
                            </p>
                            ...
                            <p style="margin-bottom: 15px;">
                                <strong>Fecha de devolución original:</strong> {{ $fechaDevolucion }}
                            </p>
